...
graph TD
    ...
    service__formula_parse_utils["⚙ formula_parse_utils"]
    service__formula_reverse_index["⚙ formula_reverse_index"]
    service__cell_formula_evaluator["⚙ cell_formula_evaluator"]
    ...
    router__excel_html --> service__cell_formula_evaluator
    ...
    router__import_templates --> service__cell_formula_evaluator
    ...
    router__report_config --> service__formula_parse_utils
    ...
    service__cell_formula_evaluator --> service__data_fetch_custom
    service__cell_formula_evaluator --> service__excel_html_converter
