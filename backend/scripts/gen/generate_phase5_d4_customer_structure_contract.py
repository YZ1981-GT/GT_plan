# -*- coding: utf-8 -*-
"""从 phase5_d4_customer_structure.build_contract_payload() 生成/校验磁盘契约。

用法：
  校验: python backend/scripts/gen/generate_phase5_d4_customer_structure_contract.py
  写盘: python backend/scripts/gen/generate_phase5_d4_customer_structure_contract.py --apply
"""
...
from app.services.workpaper_sync import phase5_d4_customer_structure as m  # noqa: E402
