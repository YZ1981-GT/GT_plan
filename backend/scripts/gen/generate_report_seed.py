...
def _bs_rows(is_consolidated: bool, is_listed: bool) -> list[dict]:
    ...
    rows = [
        ...
        {"row_code": "BS-031", "row_number": 31, "row_name": "使用权资产", "indent_level": 1, "formula": "TB('1641','期末余额')-TB('1642','期末余额')-TB('1643','期末余额')"},
    ...
    rows.extend([
        ...
        {"row_code": "BS-063", "row_number": 63, "row_name": "租赁负债", "indent_level": 1, "formula": "TB('2601','期末余额')-TB('2602','期末余额')"},
