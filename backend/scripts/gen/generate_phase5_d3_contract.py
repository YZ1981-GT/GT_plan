# -*- coding: utf-8 -*-
"""从 phase5_d3_prepaid_receipts.build_contract_payload() 生成/校验磁盘契约。

用法：
  校验: & d:/GT_plan/.venv/Scripts/python.exe backend/scripts/gen/generate_phase5_d3_contract.py
  写盘: & d:/GT_plan/.venv/Scripts/python.exe backend/scripts/gen/generate_phase5_d3_contract.py --apply
"""
...
from app.services.workpaper_sync import phase5_d3_prepaid_receipts as m  # noqa: E402
