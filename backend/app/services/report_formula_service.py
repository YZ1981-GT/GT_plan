...
_BS_SPECIAL: dict[str, str] = {
    ...
    "油气资产": "TB('1631','期末余额')",
    "使用权资产": "TB('1641','期末余额')-TB('1642','期末余额')-TB('1643','期末余额')",
    ...
    "长期借款": "TB('2501','期末余额')",
    "应付债券": "TB('2502','期末余额')",
    "租赁负债": "TB('2601','期末余额')-TB('2602','期末余额')",
    "长期应付款": "TB('2701','期末余额')",
    "预计负债": "TB('2801','期末余额')",
    "递延收益": "TB('2401','期末余额')",
...
_EQ_SPECIAL: dict[str, str] = {
    ...
    "提取专项储备": "TB('4103','期末余额')-TB('4103','年初余额')",
    ...
    # ── 所有者权益合计 ──
    "所有者权益合计": "TB('4001','期末余额')+TB('4002','期末余额')+TB('3102','期末余额')+TB('4101','期末余额')+TB('4103','期末余额')+TB('4104','期末余额')",
}
...
_IMP_SPECIAL: dict[str, str] = {
    ...
    # ── 本年计提（从损益科目取本期发生额） ──
    "本年计提坏账": "TB('6701','本期发生额')",
    "本年计提存货跌价": "TB('6702','本期发生额')",
    "信用减值损失": "TB('6701','本期发生额')",
    "资产减值损失": "TB('6702','本期发生额')",
    # ── 年初余额（从备抵科目年初取数） ──
    "坏账准备年初": "TB('1231','年初余额')",
