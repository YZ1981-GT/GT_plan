...
AUTO_ADJUSTMENT_RULES = [
    ...
    {
        "description": "处置长期资产损失",
        "account_code": "6115",
        "keywords": ["处置长期资产", "处置固定资产", "处置无形资产"],
        "category": CashFlowCategory.supplementary,
        "line_item": "处置固定资产、无形资产和其他长期资产的损失",
        "cf_row_code": "CF-S11",
    },
    {
        "description": "固定资产报废损失",
        "account_code": "6711",
        "keywords": ["固定资产报废", "营业外支出"],
        "category": CashFlowCategory.supplementary,
        "line_item": "固定资产报废损失",
        "cf_row_code": "CF-S11",
    },
