...
def register_workpaper_routers(app: FastAPI) -> None:
    ...
    groups = {
        ...
        "渲染": [wp_render_config, wp_classification, wp_html_save, wp_xlsx_export, wp_index_resolve, wp_workpaper_index_resolve, wp_trace, wp_disclosure_sync, wp_disclosure_sync_html, wp_onlyoffice],
