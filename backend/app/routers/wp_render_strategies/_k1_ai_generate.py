...
_SECTION_PROMPTS: dict[str, str] = {
    ...
    "disclosure-fund-centralization": (
        "请生成附注披露段落：披露因资金集中管理而列报于其他应收款的金额及相关情况"
        "（15号文第十九条（五）8.）。要求：①说明资金集中管理的组织方式"
        "（内部结算中心/财务公司集中归集）；②说明成员单位归集至集团母公司账户的资金"
        "在「其他应收款」项目列示的金额及口径；③如涉及「非经营性资金占有和其他关联资金"
        "往来的专项说明」，应予以关注并简要提及。面向财务报表附注读者，第三人称陈述，2~4 句；"
        "若无此类事项，输出「本期不存在因资金集中管理而列报于其他应收款的金额」的否定式表述。"
    ),
}
