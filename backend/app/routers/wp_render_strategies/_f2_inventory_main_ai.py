...
_SECTION_PROMPTS: dict[str, str] = {
    ...
    "listed-note-category": (
        "请撰写存货附注「一、存货分类」的披露说明。仅围绕上下文给出的存货类别"
        "（原材料/在产品/库存商品/周转材料/消耗性生物资产/合同履约成本等）"
        "说明账面余额、跌价准备（含合同履约成本减值准备）与账面价值的构成及主要变动；"
        "不得新增上下文中不存在的存货类别，不得虚构金额。"
    ),
    "listed-note-nrv": (
        "请撰写上市附注披露：存货可变现净值的确定依据，以及本期跌价准备转回或转销的原因。"
        "按15号文要求分别说明确定可变现净值所使用的估计售价、至完工时将发生的成本、"
        "估计的销售费用和相关税费；转回须写明导致减记因素消失的具体情形，"
        "转销须写明存货已售出或已处置。不得虚构未提供的金额与项目。"
    ),
    "listed-note-provision": (
        "请撰写上市附注披露：存货跌价准备计提的具体依据。区分按单个存货项目计提"
        "与按存货组合计提两种情形，说明组合的划分标准（如按库龄组合、按品类组合）"
        "及各自的计提比例确定方法；计提比例口径为跌价准备÷账面余额。"
        "不得虚构未提供的组合名称或比例。"
    ),
    "listed-note-borrow": (
        "请撰写存货期末余额中含有借款费用资本化金额的说明，"
        "按15号文第十九条（六）要求写明金额及其计算标准和依据。"
    ),
    "listed-note-amort": (
        "请撰写合同履约成本本期摊销金额的说明：写明本期摊销金额、"
        "摊销依据（与相关收入确认进度匹配）及计入的成本费用科目。"
    ),
    "listed-note-re": (
        "请撰写房地产开发企业存货的对外披露补充说明。仅围绕上下文给出的"
        "开发成本、开发产品、周转房三类明细，说明项目构成、期末数与上年年末数的"
        "主要变动及原因；不得虚构项目名称、开竣工时间或预计投资额。"
    ),
    "soe-note-category": (
        "请撰写国有企业口径存货附注「一、存货分类」的披露说明。按源模板的"
        "「期末数/期初数」两期口径，说明各类别账面余额、跌价准备与账面价值构成"
        "及主要变动原因；不得新增上下文中不存在的存货类别，不得虚构金额。"
    ),
    "soe-note-borrow": (
        "请撰写国企口径存货期末余额中含有借款费用资本化金额的说明，"
        "按15号文第十九条（六）要求写明金额及其计算标准和依据；"
        "若上下文未提供资本化金额，应写明本期不存在该情形。"
    ),
    "soe-note-amort": (
        "请撰写国企口径合同履约成本本期摊销金额的说明：写明本期摊销金额、"
        "摊销依据（与相关收入确认进度匹配）及计入的成本费用科目；"
        "不得虚构未提供的摊销金额。"
    ),
    "soe-note-land": (
        "请撰写国企口径「其他」项下尚未开发土地储备的说明："
        "涵盖土地储备面积、本期增加及期末余额。"
    ),
    "soe-note": (
        "请撰写国企口径存货附注「二、跌价准备」的其他应披露事项说明："
        "包括跌价准备本期计提、转回或转销的原因，以及可变现净值的确定依据；"
        "上下文未涉及的事项应写明本期不存在，不得虚构金额与项目。"
    ),
    "f2-14-note": (
