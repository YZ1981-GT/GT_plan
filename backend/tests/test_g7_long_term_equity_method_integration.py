...
测试清单:
1. G7-4/G7-13/G7-14/G7-16 export-template → 200 + multi-sheet xlsx (2 sheets)
2. G7-5/G7-15/G7-17 export-template → 200 + single-sheet xlsx
...
# ═══════════════════════════════════════════════════════════════════════════════
# 1. 宽表分sheet导出：G7-4/G7-13/G7-14/G7-16 → multi-sheet (2 data sheets)
# ═══════════════════════════════════════════════════════════════════════════════

@pytest.mark.asyncio
@pytest.mark.parametrize("sheet_code", ["G7-4", "G7-13", "G7-14", "G7-16"])
async def test_export_template_multi_sheet(sheet_code: str):
    ...
    G7-4(2区段Tab) / G7-13(2区段Tab) / G7-14(2区段Tab) / G7-16(2区段Tab)
