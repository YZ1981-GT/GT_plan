...
CREATE UNIQUE INDEX IF NOT EXISTS idx_eqcr_snapshots_current
    ON eqcr_snapshots (project_id, year)
    WHERE is_current = TRUE;

-- 查询优化索引
CREATE INDEX IF NOT EXISTS idx_eqcr_snapshots_project_year
    ON eqcr_snapshots (project_id, year);

CREATE INDEX IF NOT EXISTS idx_eqcr_snapshots_created_at
