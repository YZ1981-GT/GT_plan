...
- **✅ ledger 三 spec P0 全部完成（2026-06-07）**：header-adapter Tasks 1/2/3/5 + sign-convention Tasks 1/2/3 + diagnostics Tasks 1/2/3/4 = 174 新测试全绿；产物=ConfirmedMappingDTO+AdapterSelectionResult+SubmitGate+SignConventionTypes+V064 migration(direction_override 表+四表方向字段)+ConversionResult+BalanceDiagnosticsResult+DiagnosticCause+CauseBuilders+DataQualityAdapter；P1 剩余=header Task 4/6/7 + sign Task 4-7 + diagnostics Task 5-8；**当前最高迁移 V064**
