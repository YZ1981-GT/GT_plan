...
- [ ] 2. 实现公式引擎 useL0FormulaEngine.ts
  - [ ] 2.1 创建 `l0-confirmation/composables/useL0FormulaEngine.ts`，实现全部4个纯函数
  ...
  - [ ]* 2.3 编写 Property 2 PBT：还款检查比例公式
  ...
  - [ ]* 2.4 编写 Property 3 PBT：对账差异公式与零差异恒等
...
- [ ] 3. 实现 composable 数据管理
  - [ ] 3.1 创建 `l0-confirmation/composables/useAlternativeL05Data.ts`
...
- [ ] 4. 实现 Vue 组件
  - [ ] 4.1 创建 `confirmation/alternativeL05/GtConfirmationAlternativeL05.vue`（~400行，参照alternativeD05）
