...
- [x] 1. 公式引擎与核心纯函数
  - [x] 1.1 创建 useG6EclFormulaEngine.ts 实现8个纯函数
...
- [x] 3. 主入口与注册四件套
  - [x] 3.1 创建主入口 GtG6OtherBondInvestmentEcl.vue
  ...
  - [x] 3.3 创建后端 render 策略 _g6_other_bond_investment_ecl.py
...
- [x] 4. 数据层 composables
  ...
  - [x] 4.4 创建后端导入导出端点 _g6_other_bond_investment_ecl_import_export.py
...
- [x] 5. G6-11 三阶段划分（列式转置）
  - [x] 5.1 创建 useG6EclStageClassification.ts
  ...
  - [x] 5.2 创建 G6TabStageClassification.vue
  ...
  - [x]* 5.3 Property Test: 列式转置数据完整性 (P6)
    - **Property 6: 列式转置数据完整性**
    - fast-check验证有效列数=输出行数 + investProject对应原始列头
    - **Validates: Requirements 2.1, 2.6**

- [x] 6. G6-12 减值准备测算（22列→2区段Tab）
  - [x] 6.1 创建 useG6EclImpairmentCalc.ts
  ...
  - [x] 6.2 创建 G6TabImpairmentCalc.vue
...
- [x] 8. G6-13 ECL计量测试（49行5section）
  - [x] 8.1 创建 G6TabEclMeasurement.vue
...
- [x] 9. G6-14 转回核销 + G6-15 凭证检查
  - [x] 9.1 创建 G6TabReversalWriteOff.vue
  ...
  - [x] 9.2 创建 useG6EclVoucherCheck.ts
  ...
  - [x] 9.3 创建 G6TabVoucherCheck.vue
...
- [x] 10. AI端点与集成联动
  - [x] 10.1 创建后端AI端点 _g6_other_bond_investment_ecl_ai.py
