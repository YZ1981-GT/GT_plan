...
**统计**：Active **16**（2026-09-22 逐目录实扫 `.kiro/specs/*/` 且**带 tasks.md** 口径；目录数 18，其中 2 个为空壳：`procedure-delegation-visibility-isolation` / `visibility-isolation-go-live-hardening`） / Archived **580**（`_archive/*/*` 实扫）
