...
**最后更新**：2026-09-09
**当前分支**：`work/2026-09-08-pac-review-followups`
**统计**：Active **8**（2026-09-09 逐目录实扫 `.kiro/specs/*/`，不含 `_archive`） / Archived **566**（2026-09-09 `_archive/*/*` 实扫口径；本轮 `platform-architecture-convergence` 与 `audit-evidence-attachment-preview-format-expansion` 已物理归档）
