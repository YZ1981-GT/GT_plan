...
**统计**：Active **6**（2026-08-15 归档 `i-cycle-extraction-formula-and-disclosure-closure` 后**重新实扫** `.kiro/specs/*/` 共 **8** 个目录，其中**带 tasks.md 的 6 个**、**空壳 2 个**）/ Archived **556**（同轮实扫 `_archive/*/*` 一级子目录所得，含 6 个仅剩 evidence 无三件套的历史残留目录）

> **🔴 本轮（归档 i-cycle 后）逐目录实扫，带 tasks.md 的 6 个**：
> `amount-input-migration-and-column-typing` **0/10** ·
