...
**统计**：Active **6**（2026-09-03 逐目录实扫 `.kiro/specs/*/`：**4** 个带 `tasks.md` + 空壳 **2**（`procedure-delegation-visibility-isolation` / `visibility-isolation-go-live-hardening`）） / Archived **562**（2026-09-03 `_archive/*/*` 实扫）
...
> 🔴 另记：上文 `advanced-query-hardening-wiring-closure` 记的 **62/64** 已过期，2026-09-03 实扫为 **64/83**（任务表本身变长），属该 spec 在办范围，本轮只报不改。
