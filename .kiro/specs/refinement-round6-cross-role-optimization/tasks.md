...
- [ ] 1. CI 骨架：`.github/workflows/ci.yml`
...
- [ ] 2. pre-commit 配置 + hypothesis/ruff 入 requirements
...
- [ ] 11. QCEngine 按 enabled 过滤 + gate 规则同步
