...
- [ ] 1. 白名单基线收紧 + 游离子组件登记
  ...
  - [ ] 1.2 修改 `backend/scripts/file_size_whitelist.txt`
    ...
    - _Bugfix: Bug 1, Bug 2_
  - [ ] 1.3 验证 `python backend/scripts/check/check_file_size.py` 全绿
    - _Bugfix: Bug 1, Bug 2; Property 1_

- [ ] 2. 重建 float 金额防退化卡点
  - [ ] 2.1 新建 `backend/scripts/check/check_no_float_amount.py`
...
- [ ] 5. INDEX.md 计数刷新
  - [ ] 5.1 实测关键数字
    ...
    - 其他 INDEX.md 引用的过时数字
    - _Bugfix: Bug 6_
  - [ ] 5.2 更新 `.kiro/specs/INDEX.md` 对应章节
