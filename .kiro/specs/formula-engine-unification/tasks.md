...
- [x] 7. report_engine.evaluate_formula 改委托 L1
...
- [x] 14. formula_changed schema + 写入收口
...
- [x]* 19. 全链路真实验证（待 start-dev.bat 环境）
