...
- [ ] 0.1 openpyxl脚本读取M5盈余公积.xlsx全部10 sheet
...
- [ ] 4.1 创建 M5TabIndex.vue 底稿目录
  - _Requirements: 1.2_

- [ ] 4.2 创建 M5TabAdjudication.vue 审定表M5-1
  - 双区块(法定+任意)+TB回写
  - _Requirements: 2.1-2.7_

- [ ] 4.3 创建 M5TabDetail.vue 明细表M5-2
  - 法定+任意两区段+12公式+动态行+导入导出
  - _Requirements: 3.1-3.5_

- [ ] 4.4 创建 M5TabAccrualTest.vue 计提检查M5-4
  - 法定10%计提测试(接收M6)+50%上限判断+11公式
  - _Requirements: 4.1-4.7_

- [ ] 4.5 创建 M5TabReserveCheck.vue 检查表M5-5
  - 核对清单+结论区+AI辅助
  - _Requirements: 5.1-5.2_

- [ ] 4.6 创建 M5TabAdjustment.vue + M5TabDisclosureListed/Soe.vue
  - 调整借贷平衡 + 附注上市/国企切换
  - _Requirements: 5.3-5.5_

### Phase 5: 后端

- [ ] 5.1 创建 m5_surplus_reserve_renderer.py
  - RENDERER_DISPATCH注册 + 权益类公式验证
  - _Requirements: 1.6_

- [ ] 5.2 创建 m5_surplus_reserve.py 路由
  - 导出模板/导出数据/导入数据 + 计提测试API
  - _Requirements: 6.6_

- [ ] 5.3 创建 m5_surplus_reserve_service.py
  - 法定计提测试+汇总
...
- [ ] 7.1 单元测试：useM5FormulaEngine + useM5AccrualEngine
  - 权益类方向 + 法定10%计提 + 50%上限
  - _Requirements: P1-P6_

- [ ] 7.2 集成测试：M6→M5计提测试 + M5-M6闭环
  - _Requirements: 4.1-4.7_
