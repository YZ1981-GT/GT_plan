...
- [ ] 0.1 openpyxl脚本读取M8一般风险准备.xlsx全部9 sheet
...
- [ ] 4.1 创建 M8TabIndex.vue 底稿目录（适用性状态）
  - _Requirements: 1.2, 5.3_

- [ ] 4.2 创建 M8TabAdjudication.vue 审定表M8-1
  - 权益类单区块+计提/转回+TB回写
  - _Requirements: 2.1-2.7_

- [ ] 4.3 创建 M8TabDetail.vue 明细表M8-2
  - 22公式+动态行+导入导出
  - _Requirements: 3.1-3.2, 3.8_

- [ ] 4.4 创建 M8TabRiskTest.vue 风险测试M8-4
  - 按风险资产1.5%计提测试+13公式
  - _Requirements: 3.3-3.7_

- [ ] 4.5 创建 M8TabAdjustment.vue + M8TabDisclosureListed/Soe.vue
  - 调整借贷平衡 + 附注上市/国企切换 + AI辅助
  - _Requirements: 4.1-4.4_

### Phase 5: 后端

- [ ] 5.1 创建 m8_general_risk_reserve_renderer.py
  - RENDERER_DISPATCH注册 + 权益类公式验证
  - _Requirements: 1.6_

- [ ] 5.2 创建 m8_general_risk_reserve.py 路由
  - 导出模板/导出数据/导入数据 + 风险计提测试API
  - _Requirements: 6.6_

- [ ] 5.3 创建 m8_general_risk_reserve_service.py
  - 风险资产计提测试+汇总
  - _Requirements: 3.4_
...
- [ ] 7.1 单元测试：useM8FormulaEngine + useM8RiskEngine
  - 权益类方向 + 风险资产计提 + 计提差异
  - _Requirements: P1-P5_

- [ ] 7.2 集成测试：风险测试 + 行业守卫适用性
