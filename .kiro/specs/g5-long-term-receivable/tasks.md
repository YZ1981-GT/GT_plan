...
- [ ] 11. G5-9 三阶段划分 + G5-10 坏账准备测算 **（暂缓：待 G4-9/G4-10 完成）**
  - [ ] 11.1 G5TabStageClassification.vue — 暂缓占位
    - 列式转置→行式交互视图（同G4-9方案）
  ...
  - [ ] 11.2 G5TabImpairmentCalc.vue — 暂缓占位
...
- [ ] 15. 六大集成联动
  ...
  - [x] 15.4 附注EventBus集成
  - [ ] 15.5 行级OCR集成（G5-12 占位）
  - [ ] 15.6 复核对话集成（GtReviewTrigger 部分接入）
...
- [ ] 17. 集成测试 + E2E
  ...
  - [ ]* 17.3 Playwright E2E（g-cycle-g5-long-term-receivable.spec.ts 已建）


## Notes

- G5特色区别于G4：内含利率法(G5-5)+实际利率法(G5-6)两种测算模式、保理终止确认核查(G5-7)、87行超大审定表五层结构
- G5-9三阶段划分同G4-9列式转置方案，**暂缓待 G4-9 完成**
- ECL公式链(G5-10)同G4-10，**暂缓待 G4-10 完成**
