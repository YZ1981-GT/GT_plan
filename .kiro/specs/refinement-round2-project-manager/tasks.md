...
- [ ] 3. 后端：ManagerDashboardService 聚合
...
- [ ] 13. 前端：CommunicationCommitmentsEditor 组件
...
- [ ] 16. 前端：CrossProjectBriefExporter 组件
...
- [ ] 22. 前端：ProjectWizard 填预算字段 + ManagerDashboard 成本卡
