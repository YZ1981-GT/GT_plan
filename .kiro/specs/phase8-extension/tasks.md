...
- [ ] 5.1 实现审计类型特定的底稿模板集：IPO审计专用底稿、专项审计底稿、内控审计底稿、验资底稿、税审底稿
    - _需求: 3.2_
- [ ] 5.2 实现审计类型特定的报表模版：验资报告模版、内控审计报告模版等
    - _需求: 3.3_
- [ ] 5.3 实现审计类型特定的审计程序框架：不同审计类型的风险评估和程序清单
    - _需求: 3.4_
- [x] 5.4 实现项目创建时的审计类型推荐：根据审计类型自动推荐对应的模板集和程序
    - _需求: 3.5_
- [ ] 5.5 扩展项目初始化向导：添加审计类型选择步骤，根据选择推荐模板集
    - _需求: 3.5_
...
- [ ] 28.1 编写端到端测试：多准则项目创建、准则切换、准则对应报表生成
    - _需求: 1.1-1.6_
- [ ] 28.2 编写端到端测试：多语言界面切换、双语报表导出
    - _需求: 2.1-2.6_
- [ ] 28.3 编写端到端测试：自定义模板创建、发布、使用
    - _需求: 4.1-4.6_
- [ ] 28.4 编写端到端测试：电子签名流程（三级签名）
    - _需求: 5.1-5.6_
- [ ] 28.5 编写端到端测试：监管备案流程
    - _需求: 6.1-6.6_
- [ ] 28.6 编写端到端测试：致同编码体系底稿索引生成
    - _需求: 7.1-7.5_
- [ ] 28.7 编写端到端测试：T型账户法完整流程
    - _需求: 10.1-10.6_
- [ ] 28.8 编写端到端测试：AI插件注册、启用、配置
    - _需求: 11.1-11.5_
- [ ] 28.9 编写端到端测试：Metabase仪表板嵌入和下钻
    - _需求: 13.1-13.6_
- [ ] 28.10 编写端到端测试：附件上传、OCR识别、关联底稿
    - _需求: 14.1-14.8_
- [ ] 28.11 编写端到端测试：穿透查询完整流程
    - _需求: 15.1-15.8_

### 29. 文档

- [ ] 29.1 编写《多准则适配指南》：如何使用多准则功能、准则切换注意事项
- [ ] 29.2 编写《多语言使用指南》：如何切换语言、如何生成双语报表
- [ ] 29.3 编写《自定义模板开发指南》：如何创建自定义模板、公式DSL扩展
- [ ] 29.4 编写《电子签名使用指南》：三级签名的使用场景和操作流程
- [ ] 29.5 编写《监管对接配置指南》：如何配置中注协备案接口、如何处理备案错误
- [ ] 29.6 编写《致同底稿编码体系说明》：编码体系结构、三测联动、自定义编码
- [ ] 29.7 编写《T型账户法使用指南》：T型账户适用场景、操作步骤、注意事项
- [ ] 29.8 编写《AI插件开发指南》：如何开发AI插件、插件接口规范
- [ ] 29.9 编写《Metabase集成指南》：如何部署Metabase、如何创建仪表板、如何嵌入前端
- [ ] 29.10 编写《Paperless-ngx集成指南》：如何部署Paperless-ngx、如何配置OCR、如何集成附件管理
- [ ] 29.11 编写《穿透查询优化指南》：如何使用穿透查询API、如何优化数据库索引、如何实现虚拟滚动
...
- [ ] 32.1 评估 Teable 和 Grist 的部署复杂度、API集成可行性、数据同步方案、UI嵌入选项、许可证兼容性
    - _需求: 18.1, 18.3_
- [ ] 32.2 选择一个用例（PBC清单管理/函证管理/底稿索引管理）进行POC验证
    - _需求: 18.2, 18.4_
- [ ] 32.3 输出评估报告（采纳/推迟/拒绝）及理由
    - _需求: 18.5_
