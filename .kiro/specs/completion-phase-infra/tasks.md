...
- [ ] **PRE-1-E2E**（**E-PRE-1**）smoke 五件套：A8-1、A9-1、A16-1、A17-3、A18-1（各 spec e2e 已分散编写；统一跑绿待环境）
...
- [ ] **PRE-4-4** A11-2、A11-3（`GtEmbeddedChecklist` + bundle ✅；E2E `core-e6` 部分覆盖，专用用例待写）
...
- [ ] **PRE-1-E2E / E2E 标绿** — 依赖 seed 后 `RUN_FULL_E2E=1` 实跑 E-PRE-1 ~ E18
