...
- [ ] 5. EventBus REPORT_CONFIG_MASTER_UPDATED
  - audit_platform_schemas.py 加 EventType
  - update_config 末尾：非 project:* 才发事件
  - _需求: 2.1_

- [ ] 6. _mark_cloned_configs_stale handler
...
- [ ] 9. 前端 ReportConfigTab 入口
  - "提交主模板候选" 按钮（项目级配置行）
  - "同步主模板更新" 入口（is_stale banner 提示 N 行 diff + 选择性同步）
  - admin 审核候选列表
  - 对应 router 端点 + router_registry 注册
  - _需求: 1.1, 2.3, 2.4_
