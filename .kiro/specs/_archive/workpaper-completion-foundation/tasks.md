...
- [x] 1. Sprint 1：后端 + Composables + 属性测试
  ...
  - [x] 1.1 新增 gt-tokens.css 预填充标记 token
  ...
  - [x] 1.2 后端 GET /xlsx-to-json 注入 prefill_source 到 cellData
  ...
  - [x] 1.2b 后端 prefill_engine 新增 TB_AUX formula_type 支持
  ...
  - [x] 1.3 Alembic 迁移：cell_annotations 新增 annotation_type + sheet_name
  ...
  - [x] 1.4 新建后端端点 GET /api/projects/{pid}/workpapers/review-status
  ...
  - [x] 1.5 新建前端 composable: usePrefillMarkers
  ...
  - [x] 1.6 新建前端 composable: useCrossModuleRefs
  ...
  - [x] 1.7 新建前端 composable: useReviewMarks
  ...
  - [x] 1.8 新建前端 composable: useUserOverrides
  ...
  - [x]* 1.9 属性测试：Property 1 - Prefill cell style correctness
...
- [x] 2. Sprint 2：前端 UI 集成
  - [x] 2.1 WorkpaperEditor 工具栏"📊 一键填充"按钮
  ...
  - [x] 2.2 WorkpaperEditor 预填充 cell hover tooltip
  ...
  - [x] 2.3 WorkpaperEditor 跨模块跳转标签 overlay
  ...
  - [x] 2.4 WorkpaperEditor 右键菜单"✓ 标记复核"
  ...
  - [x] 2.5 WorkpaperEditor 侧面板"复核标记"Tab
  ...
  - [x] 2.6 WorkpaperEditor User Override 检测与标记
  ...
  - [x] 2.10 Checkpoint - Sprint 2 验证
    - getDiagnostics 对所有修改的 Vue 文件零错误
    - vue-tsc --noEmit 通过
    - Ensure all tests pass, ask the user if questions arise.

- [x] 3. Sprint 3：E2E 测试 + 验收
  - [x] 3.1 Playwright E2E 配置与测试数据准备
