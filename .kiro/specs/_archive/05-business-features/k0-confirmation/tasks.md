...
- [x] 2. 实现公式引擎 useK0FormulaEngine.ts
  - [x] 2.1 创建 `k0-confirmation/composables/useK0FormulaEngine.ts`，实现全部5个纯函数
  ...
  - [x]* 2.3 编写 Property 2 PBT：检查比例公式
  ...
  - [x]* 2.4 编写 Property 3 PBT：行差异公式与零差异恒等
  ...
  - [x]* 2.5 编写 Property 4 PBT：对账差异公式与零差异恒等
...
- [x] 3. 实现 composable 数据管理
  - [x] 3.1 创建 `k0-confirmation/composables/useAlternativeK05Data.ts`
  ...
  - [x] 3.2 创建 `k0-confirmation/composables/useAlternativeK06Data.ts`
...
- [x] 4. 实现 Vue 组件
  - [x] 4.1 创建 `confirmation/alternativeK05/GtConfirmationAlternativeK05.vue`（~400行，参照alternativeD05）
  ...
  - [x] 4.2 创建 `confirmation/alternativeK06/GtConfirmationAlternativeK06.vue`（~400行，参照alternativeD06）
