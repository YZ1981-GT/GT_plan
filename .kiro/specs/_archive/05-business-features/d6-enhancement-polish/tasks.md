...
- [x] 1. D6-2 明细表列设置 ⚙ popover
  - [x] 1.1 创建 `composables/useD6DetailColumnPrefs.ts`
...
- [x] 6. D6-4 调整分录补审计目标 el-alert
  - [x] 6.1 在 D6TabAdjustment.vue 编制提示下方加审计目标
...
- [x] 7. D6-9 转回核销 ↔ D6-3 勾稽校验
  - [x] 7.1 在 D6TabWriteoffCheck.vue 加勾稽校验
...
- [x] 8. D6 主入口 saveImmediate 触发快照
  - [x] 8.1 在 GtD6ContractAssets.vue 包装 saveImmediate
