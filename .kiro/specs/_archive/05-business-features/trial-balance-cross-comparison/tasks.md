...
- [x] 5. PBT + vitest suite: Property 1 (join correctness), P2 (variance calc including zero-division), P3 (403 handling), P4 (cache invalidation), P5 (max 5 limit), P6 (export headers), P7 (zero regression).
- [x] 6.\* Playwright end-to-end: toggle comparison → select year → variance renders → filter → export → back to normal view.
