...
- [x] 26. 抽凭引擎集成（F2-33/34 已实现在 f2-inventory-valuation，见该 spec Task 17）
...
- [x] 30. 行级OCR集成（F2-33 📎 已实现在 f2-inventory-valuation Task 19）
