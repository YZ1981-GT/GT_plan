"""为 J1–J3 tasks.md 注入 JSON waves 块（替换 mermaid 依赖图）。"""
...
# spec_folder, wave-2..wave-9 task lists
WAVE_CONFIGS: list[tuple[str, list[str], list[str], list[str], list[str], list[str], list[str], list[str], list[str]]] = [
    (
...
def build_waves_json(
    ...
    waves = [
        ...
        _wave("wave-5", "Phase3 sheet/check composables", w5),
        _wave("wave-6", "Phase4 Vue 子组件", w6),
        _wave("wave-7", "Phase5 后端四件套", w7),
