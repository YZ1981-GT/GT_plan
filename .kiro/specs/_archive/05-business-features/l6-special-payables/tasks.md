...
- [x] 0.1 openpyxl脚本读取L6专项应付款.xlsx全部8 sheet
...
- [x] 2.1 创建 `useL6FormulaEngine.ts`（负债类！）
...
- [x] 3.1 创建 useL6FormData.ts
  - selfLoad + checklist_responses + writebackTB(2601)
  - _Requirements: 1.9, 1.10, 2.6_

- [x] 3.2 创建 useL6CrossSheet.ts
  - adjudicationVsDetail
  - _Requirements: 2.5, 3.5_

- [x] 3.3 创建 useL6DualMode.ts + useL6ImportExport.ts
...
- [x] 4.1 创建 L6TabIndex.vue 底稿目录
  - 8行+进度条
  - _Requirements: 1.2_

- [x] 4.2 创建 L6TabAdjudication.vue 审定表L6-1
  - 负债类单区块+项目小计+TB回写
  - _Requirements: 2.1-2.7_

- [x] 4.3 创建 L6TabDetail.vue 明细表L6-2
  - 33列区段Tab切换+动态行+导入导出
  - _Requirements: 3.1-3.5_

- [x] 4.4 创建 L6TabSpecialCheck.vue 检查表L6-4
  - 专款专用核查+用途不符高亮+结论区+AI辅助
  - _Requirements: 4.1-4.4_

- [x] 4.5 创建 L6TabAdjustment.vue + L6TabDisclosureListed/Soe.vue
  - 调整借贷平衡 + 附注上市/国企切换
  - _Requirements: 5.1-5.3_

### Phase 5: 后端

- [x] 5.1 创建 l6_special_payables_renderer.py
  - RENDERER_DISPATCH注册 + 负债类公式验证
  - _Requirements: 1.6_

- [x] 5.2 创建 l6_special_payables.py 路由
  - 导出模板/导出数据/导入数据
  - _Requirements: 6.5_

- [x] 5.3 创建 l6_special_payables_service.py
  - 负债类公式验证+专款专用核查
