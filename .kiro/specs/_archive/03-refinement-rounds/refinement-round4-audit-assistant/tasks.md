...
- [x] 2. 前端：ProgramRequirementsSidebar 组件
...
- [x] 7. 前端：MyProcedureTasks 跳转带上下文
...
- [x] 10. 前端：PriorYearCompareDrawer 抽屉
...
- [x] 18. 前端：useFocusTracker + PersonalDashboard 时间线
