...
- [x] 14. 前端：AuditReportEditor 状态标签
...
- [x] 19. 前端：EqcrMemoEditor
  - 模板预览 + 富文本编辑 + 定稿按钮
  - _需求_ 9

- [x] 20. 后端 + 前端：EQCR 指标仪表盘
