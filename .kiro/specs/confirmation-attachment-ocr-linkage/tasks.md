...
- [ ] 1. Wave 0 — 安全网 + 迁移 + ORM 骨架

- [ ] 1.1 characterization 基线锁定既有行为
...
- [ ] 2. Wave 1 — M1 状态撤回（独立可用）

- [ ] 2.1 reverse_status 服务
...
- [ ] 3. Wave 2 — M2 台账↔附件链（发函件/回函件强配对）

- [ ] 3.1 ConfirmationEvidenceService 附件链
...
- [ ] 4. Wave 3 — M3 回函 OCR 识别 + 比对 + 人工确认回填

- [ ] 4.1 extract_and_compare
