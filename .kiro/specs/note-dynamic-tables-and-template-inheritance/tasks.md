...
- [x] **A.7.1** group_note_baseline_service.py（save/apply/diff/sync）
- [x] **A.7.2** 多层级 lineage（parent_baseline_id 链）
- [x] **A.7.3** apply_group_baseline 复制文字+表样+vars
- [x] **A.7.4** local_override 标记
- [x] **A.7.5** 基线版本管理 v{major}.{minor}
- [x] **A.7.6** 基线升级通知
- [x] **A.7.7** 多 child 批量同步
- [x] **A.7.8** child 反哺基线建议
- [x] **A.7.9** 新 router group_note_baseline.py（5 端点）
- [x] **A.7.10** **template_type 一致性检查（与 D14 联动）**
- [x] **A.7.11** 验收（CI-7）
