...
- [ ] 0.1 openpyxl脚本读取H6固定资产清理.xlsx全部8 sheet
...
- [ ] 2.1 创建 `composables/useH6FormulaEngine.ts`
...
- [ ]* 2.5 编写 Property P4 PBT：过渡科目零余额判定
...
- [ ] 4.1 创建 H6TabIndex.vue 底稿目录
  - 8行sheet列表+进度条+过渡科目状态指示
  - _Requirements: 1.2, 6.1_

- [ ] 4.2 创建 H6TabAdjudication.vue 审定表H6-1
  - 59公式+过渡科目期末=0校验+H10交叉验证+TB回写
  - _Requirements: 2.1-2.9_

- [ ] 4.3 创建 H6TabDetail.vue 明细表H6-2
  - 25列2区块+净损益计算+GtIndexChip(H1/H10)+动态行+导入导出
  - _Requirements: 3.1-3.7_

- [ ] 4.4 创建 H6TabAdjustment.vue 调整分录H6-3
  - 10列+借贷平衡+EventBus
  - _Requirements: 4.1-4.2_

- [ ] 4.5 创建 H6TabCheck.vue 检查表H6-4
  - 18列+合规/不合规选择+统计摘要+与H6-2联动
  - _Requirements: 4.3-4.6_

- [ ] 4.6 创建 H6TabDisclosureListed.vue + H6TabDisclosureSoe.vue
  - 附注嵌套表
  - _Requirements: 1.2_

### Phase 5: 后端

- [ ] 5.1 创建 h6_asset_disposal_clearing_renderer.py
  - RENDERER_DISPATCH注册 + 过渡科目校验逻辑
  - _Requirements: 1.6, 6.3_

- [ ] 5.2 创建 h6_asset_disposal_clearing.py 路由
...
- [ ] 7.1 单元测试：useH6FormulaEngine全部纯函数
