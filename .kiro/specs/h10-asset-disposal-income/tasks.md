...
- [ ] 0.1 openpyxl脚本读取H10资产处置损益.xlsx全部8 sheet
...
- [ ]* 2.4 编写 Property P2 PBT：损益类净发生额（贷-借）
...
- [ ] 4.1 创建 H10TabIndex.vue 底稿目录
  - 8行+进度条+来源追溯链状态（显示各源底稿编制状态）
  - _Requirements: 1.2_

- [ ] 4.2 创建 H10TabAdjudication.vue 审定表H10-1
  - 69公式+损益取数+发生额+H6交叉验证+各源底稿合计验证+TB回写
  - _Requirements: 2.1-2.10_

- [ ] 4.3 创建 H10TabDetail.vue 明细表H10-2
  - 36列3区段26公式+来源底稿GtIndexChip+动态行+统计摘要+导入导出
  - _Requirements: 3.1-3.7_

- [ ] 4.4 创建 H10TabAdjustment.vue 调整分录H10-3
  - 10列+借贷平衡+EventBus+双向同步H10-1
  - _Requirements: 4.1_

- [ ] 4.5 创建 H10TabCheck.vue 检查表H10-4
  - 80行20列+合规判断+与H10-2联动+抽凭+不合规摘要
  - _Requirements: 4.2-4.6_

- [ ] 4.6 创建 H10TabDisclosureListed/Soe.vue
  - 附注
  - _Requirements: 1.2_

### Phase 5: 后端

- [ ] 5.1 创建 h10_asset_disposal_income_renderer.py
  - RENDERER_DISPATCH注册 + **损益类取数逻辑**（发生额！）
  - _Requirements: 1.6, 6.2_

- [ ] 5.2 创建 h10_asset_disposal_income.py 路由
  - 导出模板/导出数据/导入数据
  - _Requirements: 3.5_

- [ ] 5.3 创建 h10_asset_disposal_income_service.py
...
- [ ] 7.1 单元测试：useH10FormulaEngine + useH10DisposalCalcEngine
