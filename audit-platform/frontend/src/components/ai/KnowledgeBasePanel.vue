...
.search-input:focus { outline: none; border-color: var(--gt-color-primary); }
...
.btn-secondary { background: var(--gt-color-bg-white); border: 1px solid var(--gt-color-border-light); }
