...
/**
 * F4 编制/使用手册弹窗 — 对齐 D1/E1 PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：F4-2 明细立清单 → F4-7 未入账检查(完整性核心)/F4-8 凭证/F4-6 关联方/F4-9 供应链融资 → F4-5 长期挂账判断 → 差异进 F4-3 → 确认回写 F4-1 → 勾稽 TB(2202) → 附注。本弹窗不改各表页内说明。"
    />
