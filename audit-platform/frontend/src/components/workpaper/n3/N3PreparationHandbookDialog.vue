...
/**
 * N3 编制/使用手册弹窗 — 对齐 N1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  <el-dialog
    ...
    title="N3 递延所得税负债 · 编制手册"
    width="860px"
    top="4vh"
    destroy-on-close
    append-to-body
    class="n3-handbook-dialog"
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：N3-2 明细(应纳税暂时性差异×税率) → 差异进 N3-3 → 确认回写 N3-1 → 勾稽 TB(2901) + 与 N1 同源分列 + 核对 N5 → 附注。负债类贷方取期末余额。本弹窗不改各表页内说明。"
    />
