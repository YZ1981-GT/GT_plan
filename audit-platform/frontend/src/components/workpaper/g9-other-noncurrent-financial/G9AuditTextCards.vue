...
/**
 * G9 审计说明 / 结论卡片（含 AI）— 各子表统一复用
 */
import { computed } from 'vue'
import { useG9AiGenerate, type G9AiSection } from '../composables/useG9AiGenerate'
...
const props = withDefaults(defineProps<{
  ...
  noteAiSection?: G9AiSection | ''
  conclusionAiSection?: G9AiSection | ''
...
const { aiAvailable, loading: aiLoading, generateAndConfirm } = useG9AiGenerate(wpIdRef)
...
<style scoped>
.g9-audit-text-cards { display: flex; flex-direction: column; gap: 0; }
.audit-text-card {
  margin-top: 14px;
