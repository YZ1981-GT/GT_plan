<template>
  <div class="h8-tab-index">
    ...
    />
    <H8PreparationHandbookDialog v-model="handbookVisible" :initial-tab="handbookTab" />
...
const H8PreparationHandbookDialog = defineAsyncComponent(() => import('../H8PreparationHandbookDialog.vue'))
