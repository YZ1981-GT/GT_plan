...
export const CYCLE_CONFIG: Record<number, { name: string; b23ProcessNum: number; targetCycle: string; targetCycleName: string }> = {
  ...
  5:  { name: '投资循环', b23ProcessNum: 7, targetCycle: 'GA', targetCycleName: '投资' },
  6:  { name: '固定资产循环', b23ProcessNum: 6, targetCycle: 'HA', targetCycleName: '固定资产' },
  7:  { name: '在建工程循环', b23ProcessNum: 6, targetCycle: 'HA', targetCycleName: '在建工程' },
  8:  { name: '无形资产及其他长期资产循环', b23ProcessNum: 6, targetCycle: 'IA', targetCycleName: '无形资产' },
  9:  { name: '研发循环', b23ProcessNum: 6, targetCycle: 'IA', targetCycleName: '研发' },
  10: { name: '职工薪酬循环', b23ProcessNum: 5, targetCycle: 'JA', targetCycleName: '职工薪酬' },
  11: { name: '管理循环', b23ProcessNum: 8, targetCycle: 'KA', targetCycleName: '管理' },
  12: { name: '税金循环', b23ProcessNum: 8, targetCycle: 'NA', targetCycleName: '税金' },
  13: { name: '债务循环', b23ProcessNum: 8, targetCycle: 'LA', targetCycleName: '债务' },
  14: { name: '租赁循环', b23ProcessNum: 8, targetCycle: 'HA', targetCycleName: '租赁' },
  15: { name: '关联方循环', b23ProcessNum: 8, targetCycle: 'KA', targetCycleName: '关联方' },
}
