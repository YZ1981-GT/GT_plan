/**
 * useD4ReviewThreads — D4 复核线程蓝/红点
 */
import { ref, onMounted, type Ref } from 'vue'
import http from '@/utils/http'

export function useD4ReviewThreads(wpId: Ref<string>) {
  ...
  return { activeThreads, getThreadDot, reload: loadActiveThreads }
}

export default useD4ReviewThreads
