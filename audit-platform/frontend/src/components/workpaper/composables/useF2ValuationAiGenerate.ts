/**
 * useF2ValuationAiGenerate — F2 计价/跌价组 AI（POST /f2-val/ai-generate）
 */
  ...
  async function generateAndConfirm(
    ...
    try {
      const res = await http.post(
        `/api/workpapers/${wpId.value}/f2-val/ai-generate`,
...
export default useF2ValuationAiGenerate
