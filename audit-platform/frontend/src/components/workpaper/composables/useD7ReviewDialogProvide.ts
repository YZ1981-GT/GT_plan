/**
 * useD7ReviewDialogProvide — D7 复核对话 provider
 */
...
export type D7OpenReviewParams = {
  sectionId: string
  sectionLabel?: string
  relatedData?: Record<string, unknown>
}

export type D7OpenReviewFn = (sectionIdOrParams: string | D7OpenReviewParams) => void
...
function normalizeParams(sectionIdOrParams: string | D7OpenReviewParams): D7OpenReviewParams {
...
export function useD7ReviewDialogProvide(options: {
  wpId: Ref<string>
  ...
  const openReview: D7OpenReviewFn = (sectionIdOrParams) => {
...
export default useD7ReviewDialogProvide
