/**
 * D1 复核线程活跃态 — 蓝/红点（对齐 D2 useD2ReviewThreads）
 */
import { ref, onMounted, type Ref } from 'vue'
import http from '@/utils/http'

export function useD1ReviewThreads(wpId: Ref<string>) {
  ...
  /** 行级复核：匹配 `${prefix}-${rowKey}-*` 的 section_id */
...
export default useD1ReviewThreads
