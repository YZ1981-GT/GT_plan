/**
 * useD6ReviewDialogProvide — D6 复核对话 provider
 */
...
export type D6OpenReviewParams = {
  sectionId: string
  sectionLabel?: string
  relatedData?: Record<string, unknown>
}

export type D6OpenReviewFn = (sectionIdOrParams: string | D6OpenReviewParams) => void
...
function normalizeParams(sectionIdOrParams: string | D6OpenReviewParams): D6OpenReviewParams {
...
export function useD6ReviewDialogProvide(options: {
  wpId: Ref<string>
  ...
  const openReview: D6OpenReviewFn = (sectionIdOrParams) => {
...
export default useD6ReviewDialogProvide
