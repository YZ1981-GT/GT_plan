/**
 * useD3DisclosureSoe — 附注披露信息（国企）核心逻辑 composable
 *
...
export function useD3DisclosureSoe(options: UseD3DisclosureSoeOptions) {
...
export default useD3DisclosureSoe
