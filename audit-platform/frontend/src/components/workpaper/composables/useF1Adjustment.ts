/**
 * useF1Adjustment — F1-3 调整分录汇总表核心逻辑 composable
 *
 ...
 * - rows reactive（从F1-aje-rows加载JSON）
...
export interface UseF1AdjustmentOptions {
...
const ITEM_ID_ROWS = 'F1-aje-rows'
...
export function useF1Adjustment(options: UseF1AdjustmentOptions) {
...
export default useF1Adjustment
