/**
 * useD4ReviewDialogProvide — D4 营业收入复核对话 provider
 */
...
export type D4OpenReviewParams = {
  sectionId: string
  sectionLabel?: string
  relatedData?: Record<string, unknown>
}

export type D4OpenReviewFn = (sectionIdOrParams: string | D4OpenReviewParams) => void
...
function normalizeParams(sectionIdOrParams: string | D4OpenReviewParams): D4OpenReviewParams {
...
export function useD4ReviewDialogProvide(options: {
  wpId: Ref<string>
  ...
  const openReview: D4OpenReviewFn = (sectionIdOrParams) => {
...
export default useD4ReviewDialogProvide
