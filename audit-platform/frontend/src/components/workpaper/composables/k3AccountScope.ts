 ...
 * K3 其他应付款 — 科目码单一真源。
 *
 * 报表行：BS-053（上市）/ BS-075（国企）
 * 公式：TB('2241','期末余额') 四准则一致
 * 兜底码：2241
 *
...
/** 报表行编码 —— 上市准则 */
export const K3_REPORT_ROW_CODE_LISTED = 'BS-053'

/** 报表行编码 —— 国企准则 */
export const K3_REPORT_ROW_CODE_SOE = 'BS-075'
...
export function k3QueryCodes(src?: K3TbSourceCodes | null): string[] {
  ...
  return resolved.length ? resolved : ['2241']
}
