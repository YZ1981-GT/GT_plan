...
import { useG4BonSppFormData } from './composables/useG4BonSppFormData'
...
const formData = useG4BonSppFormData({ wpId: wpIdRef, projectId: computed(() => props.projectId) })
...
<style scoped>.g4-bond-investment-sppi { padding: 12px; } .loading-container { padding: 24px; } .g4-bond-investment-sppi-toolbar { margin-bottom: 8px; }</style>
