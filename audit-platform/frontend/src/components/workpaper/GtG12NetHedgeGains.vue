<template>
  <div class="g12-net-hedge-gains">
    ...
    <template v-else>
      <div class="g12-net-hedge-gains-toolbar">
        <el-button size="small" @click="versionToolbar.openVersionHistory()">版本历史</el-button>
      </div>

      <GtOnlyOfficeSheet
        v-if="currentSheet === 'G12A'"
        :wp-id="props.wpId"
...
import { useG12NetHedFormData } from './composables/useG12NetHedFormData'
...
const formData = useG12NetHedFormData({ wpId: wpIdRef, projectId: computed(() => props.projectId) })
...
const useGridFallback = computed(() => {
  ...
  return !!code && code !== 'G12A' && !adjudicationConfig.value && !code.startsWith('附注')
})
...
.g12-net-hedge-gains-toolbar { margin-bottom: 8px; }
</style>
