...
import { useG6MainAiGenerate, type G6MainAiSection } from '../composables/useG6MainAiGenerate'
...
const props = withDefaults(defineProps<{
  ...
  noteAiSection?: G6MainAiSection | ''
  conclusionAiSection?: G6MainAiSection | ''
...
const { aiAvailable, loading: aiLoading, generateAndConfirm } = useG6MainAiGenerate(wpIdRef)
...
<style scoped>
.g6-audit-text-cards { display: flex; flex-direction: column; gap: 0; }
.audit-text-card {
  margin-top: 14px;
