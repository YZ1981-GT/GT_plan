...
import { useG7EquMaiFormData } from './composables/useG7EquMaiFormData'
...
const formData = useG7EquMaiFormData({ wpId: wpIdRef, projectId: computed(() => props.projectId) })
...
<style scoped>.g7-long-term-equity-main { padding: 12px; } .loading-container { padding: 24px; } .g7-long-term-equity-main-toolbar { margin-bottom: 8px; }</style>
