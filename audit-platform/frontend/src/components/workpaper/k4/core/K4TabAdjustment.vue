...
<style scoped>
.k4-tab-adjustment { padding: 12px; font-size: 13px; }
...
/* 合计行 */
.k4-adj-footer { display: flex; align-items: center; gap: 16px; margin-top: 8px; padding: 10px 16px; background: #f0f9eb; border-radius: 4px; font-weight: 600; font-size: 13px; }
