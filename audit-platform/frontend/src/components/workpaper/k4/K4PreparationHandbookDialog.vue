...
/**
 * K4 编制/使用手册弹窗 — 对齐 E1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  <el-dialog
    ...
    title="K4 其他流动负债 · 编制手册"
    width="860px"
    top="4vh"
    destroy-on-close
    append-to-body
    class="k4-handbook-dialog"
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：K4-2 明细按项目立清单 → K4-4 检查表核对分类/流动性/完整性/合规性 → 差异进 K4-3 → 确认回写 K4-1 → 勾稽 TB(2245) → 附注。本弹窗不改各表页内说明。"
    />
