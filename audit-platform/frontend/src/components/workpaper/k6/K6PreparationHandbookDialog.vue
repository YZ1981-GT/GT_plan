...
/**
 * K6 编制/使用手册弹窗 — 对齐 E1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  <el-dialog
    ...
    title="K6 持有待售资产和负债 · 编制手册"
    width="860px"
    top="4vh"
    destroy-on-close
    append-to-body
    class="k6-handbook-dialog"
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：K6-4 CAS42 五条件初始确认 → K6-2 登记处置组/资产 → 减值孰低(K6-5)/处置组分摊(K6-6)/不再满足(K6-7) → 差异进 K6-3 → 确认回写 K6-1 → 勾稽 TB(1481+2605) → 附注。本弹窗不改各表页内说明。"
    />
