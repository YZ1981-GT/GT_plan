<!--
  I5SheetImportExport — 统一导入导出下拉（I5-2 / I5-3）
-->
<template>
  <span class="i5-ie-wrap">
...
import { useI5ImportExport, type I5ImportableSheet } from '../../composables/useI5ImportExport'

const props = defineProps<{
  sheet: I5ImportableSheet
  wpId: string
  projectId: string
  disabled?: boolean
}>()
...
const { exportTemplate, exportData, importData, importing } = useI5ImportExport({
