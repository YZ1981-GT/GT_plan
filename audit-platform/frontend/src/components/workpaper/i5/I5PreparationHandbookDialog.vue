...
/**
 * I5 编制/使用手册弹窗 — 对齐 I1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  <el-dialog
    ...
    title="I5 其他非流动资产 · 编制手册"
    width="860px"
    top="4vh"
    destroy-on-close
    append-to-body
    class="i5-handbook-dialog"
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：I5-2 明细(原值/减值/净值三层) + I5-4 针对性检查 → I5-1 审定(账面净值 = 原值 − 减值准备) → 回写 TB(1911)+附注。1911 其他非流动资产为资产借方，期末 = 期初 + 增加 − 减少。本弹窗不改各表页内说明。"
    />
