...
/**
 * K5 编制/使用手册弹窗 — 对齐 E1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：K5-2 识别或有事项(CAS13三级可能性)+最佳估计数 → 质保(K5-4)/弃置(K5-5)/诉讼(K5-6)专项检查回连 → K5-7 综合检查 → 差异进 K5-3 → 确认回写 K5-1 → 勾稽 TB(2701) → 附注(预计负债+或有负债)。本弹窗不改各表页内说明。"
    />
