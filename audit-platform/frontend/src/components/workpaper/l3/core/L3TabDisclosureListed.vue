...
let _l3ListedMounted = false
watch(
  [classificationRows, currentPortionRows, propertyNote, conclusion],
  () => {
    if (!_l3ListedMounted) { _l3ListedMounted = true; return }
