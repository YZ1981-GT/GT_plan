...
import { useG6OthBonFormData } from './composables/useG6OthBonFormData'
...
const formData = useG6OthBonFormData({ wpId: wpIdRef, projectId: computed(() => props.projectId) })
...
<style scoped>.g6-other-bond-investment-main { padding: 12px; } .loading-container { padding: 24px; } .g6-other-bond-investment-main-toolbar { margin-bottom: 8px; }</style>
