<template>
  <div class="g4-sppi-import-export-dropdown">
...
/**
 * G4 SPPI 导入导出下拉 — 对齐 G2（导出模板 / 导出数据 / 导入数据）
 * 支持 sheet: G4-5 / G4-6 / G4-7 / G4-8
 */
import { ref, toRef } from 'vue'
import { ElMessage } from 'element-plus'
import { useG4SppiImportExport, type G4SppiImportableSheet } from '../composables/useG4SppiImportExport'

const props = defineProps<{
  wpId: string
  sheet: G4SppiImportableSheet
  disabled?: boolean
}>()
...
const ie = useG4SppiImportExport({ wpId: toRef(props, 'wpId') })
