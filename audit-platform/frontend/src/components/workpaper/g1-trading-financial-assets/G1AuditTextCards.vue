...
/**
 * G1 审计说明 / 结论卡片（含 AI）— 各子表统一复用
 */
import { computed } from 'vue'
import { useG1AiGenerate, type G1AiSection } from '../composables/useG1AiGenerate'
...
const props = withDefaults(defineProps<{
  ...
  noteAiSection?: G1AiSection | ''
  conclusionAiSection?: G1AiSection | ''
...
const { aiAvailable, loading: aiLoading, generateAndConfirm } = useG1AiGenerate(wpIdRef)
...
<style scoped>
.g1-audit-text-cards { display: flex; flex-direction: column; gap: 0; }
.audit-text-card {
  margin-top: 14px;
