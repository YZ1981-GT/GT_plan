...
<style scoped>
.g1-disclosure { padding: 12px; font-size: 13px; }
.g1-disclosure :deep(.el-table) { --el-table-font-size: 13px; font-size: 13px; }
.g1-disclosure :deep(.el-table .cell) { font-size: 13px; }
