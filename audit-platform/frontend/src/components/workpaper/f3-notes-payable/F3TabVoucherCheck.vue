  ...
  <div class="f3-tab-voucher">
    ...
    <details class="guidance-details">
      ...
      <div class="guidance-content">
        ...
        <p>6. <strong>完整性（负债首要认定）</strong>：日后借方区应作未入账应付票据搜索——从 E1 货币资金银行流水/期后付款、开票承兑及贴现记录反查是否存在已承兑但未入账的票据，关注应计未计的截止性错报。</p>
      </div>
    </details>
    ...
    <el-alert
      type="info"
      :closable="false"
      title="审计目标：1.应付票据完整（无未入账/漏记的已承兑票据）；2.存在且记录于恰当账户；3.由被审计单位拥有或控制；4.以恰当金额包括在财务报表中，计价分摊调整已恰当记录，披露恰当。"
