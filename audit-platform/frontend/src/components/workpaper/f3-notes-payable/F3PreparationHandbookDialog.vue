...
/**
 * F3 编制/使用手册弹窗 — 对齐 D1/E1 PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：F3-2 明细立清单（含供应链票据）→ F3-7 凭证检查与完整性搜索 → F3-5 逾期/F3-6 关联方/F3-4 利息测算 → 差异进 F3-3 → 确认回写 F3-1 → 勾稽 TB(2201) → 附注。本弹窗不改各表页内说明。"
    />
