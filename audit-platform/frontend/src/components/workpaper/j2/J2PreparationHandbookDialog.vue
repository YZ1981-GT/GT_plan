...
/**
 * J2 编制/使用手册弹窗 — 对齐 J1/N1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  <el-dialog
    ...
    title="J2 长期应付职工薪酬 · 编制手册"
    width="860px"
    top="4vh"
    destroy-on-close
    append-to-body
    class="j2-handbook-dialog"
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：设定受益计划按 CAS9 —— J2-4 精算假设+六要素检查 → J2-2 明细 → 差异进 J2-3 → 回写 J2-1 → 联动 M9(OCI) → 勾稽 TB → 附注。重计量计入其他综合收益。本弹窗不改各表页内说明。"
    />
