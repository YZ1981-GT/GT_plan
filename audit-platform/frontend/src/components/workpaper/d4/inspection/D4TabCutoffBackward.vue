      ...
      <el-table :data="rows" border stripe class="cutoff-table" :row-class-name="rowClassName">
        ...
        <el-table-column label="发货单" align="center" class-name="col-delivery">
          ...
          <el-table-column label="金额" min-width="110" align="right">
            <template #default="{ row }"><el-input-number v-model="row.deliveryAmount" size="small" :controls="false" :disabled="isReadonly" style="width:100%" @change="onCellChange(row)" /></template>
          </el-table-column>
        </el-table-column>
        ...
        <el-table-column label="记账凭证" align="center" class-name="col-voucher">
          ...
          <el-table-column label="金额" min-width="110" align="right">
            <template #default="{ row }"><el-input-number v-model="row.voucherAmount" size="small" :controls="false" :disabled="isReadonly" style="width:100%" @change="persistAll()" /></template>
          </el-table-column>
        </el-table-column>
...
<style scoped>
.d4-cutoff-backward { padding: 16px 20px; font-size: 13px; }
...
.cutoff-date-bar { margin-bottom: 14px; display: flex; align-items: center; gap: 8px; font-size: 13px; color: #606266; }
