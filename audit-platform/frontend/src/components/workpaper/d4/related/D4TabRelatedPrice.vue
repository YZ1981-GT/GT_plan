...
// ─── 双模式 sync bridge：统一 useD4SyncMode（治本收敛）── sheet_key=d421-managed。
// 宿主 GtD4OperatingRevenue 须把 'D4-21' 登记进 isD4DedicatedSyncSheet，否则叠加 legacy 双切换器。
