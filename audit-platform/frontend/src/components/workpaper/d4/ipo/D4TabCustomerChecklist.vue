...
<style scoped>
.d4-customer-checklist{padding:16px 20px;font-size:13px}.toolbar{display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;flex-wrap:wrap;gap:8px}.toolbar-left{display:flex;align-items:center}.toolbar-right{display:flex;gap:8px;align-items:center;flex-wrap:wrap}
...
.checklist-table{font-size:13px}.checklist-table :deep(.el-table__cell){padding:5px 3px}.checklist-table :deep(.col-check .el-table__cell){background-color:#f0f9eb !important}
