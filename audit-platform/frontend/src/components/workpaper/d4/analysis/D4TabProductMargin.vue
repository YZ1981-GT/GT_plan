...
.sub-title { font-size: 13px; font-weight: 600; color: #303133; margin: 0 0 8px; }
.industry-table { width: 100%; border-collapse: collapse; font-size: 13px; white-space: nowrap; }
