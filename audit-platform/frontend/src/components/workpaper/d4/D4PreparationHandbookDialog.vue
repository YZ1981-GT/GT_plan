...
/**
 * D4 编制/使用手册弹窗 — 对齐 E1/K2PreparationHandbookDialog，渲染 handbooks/*.md
 * 位于 d4/ 循环根目录（D4TabIndex 在 d4/core/，以 ../ 引用本弹窗）。
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：D4-2/D4-3 明细立清单(可从序时账取数) → 发生/截止/完整性取证 + 分析程序 → 差异进 D4-4 → 确认回写 D4-1 → 勾稽 TB(6001/6051)/利润表 → 附注。本弹窗不改各表页内说明。"
    />
