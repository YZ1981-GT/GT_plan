...
<style scoped>
.d4-other-check{padding:16px 20px;font-size:13px}
...
.stats-bar{display:flex;gap:20px;margin-bottom:12px;padding:8px 14px;background:linear-gradient(135deg,#f8f9fe,#f0f4ff);border-radius:6px;border:1px solid #e4e7ed;font-size:13px;color:#606266}.stat-item strong{color:#303133;margin-left:4px}.stat-item.warn{color:#f56c6c}.stat-item.warn strong{color:#f56c6c}
...
.check-table{font-size:13px}.check-table :deep(.el-table__cell){padding:4px 3px}.check-table :deep(.col-check .el-table__cell){background-color:#f0f9eb !important}.check-table :deep(.row-anomaly td){background-color:#fef0f0 !important}
