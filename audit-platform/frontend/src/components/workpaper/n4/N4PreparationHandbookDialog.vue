...
/**
 * N4 编制/使用手册弹窗 — 对齐 N1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：N4-2 明细(逐税种发生额) → 差异进 N4-3 → 确认回写 N4-1 → 勾稽 TB(6403 发生额)+利润表 + 各税种费用核对 N2 计提额 → 附注。损益类借方取本期发生额。本弹窗不改各表页内说明。"
    />
