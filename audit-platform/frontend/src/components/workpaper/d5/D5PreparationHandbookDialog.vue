...
/**
 * D5 编制/使用手册弹窗 — 对齐 E1/K2PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  <el-dialog
    ...
    title="D5 应收款项融资 · 编制手册"
    width="860px"
    top="4vh"
    destroy-on-close
    append-to-body
    class="d5-handbook-dialog"
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：D5-2 明细立清单(标注质押/背书贴现) → 公允价值测算(D5-4) → 差异进 D5-3 → 确认回写 D5-1 → 勾稽 TB(1124) → 附注(质押/背书贴现终止确认)。本弹窗不改各表页内说明。"
    />
