...
/**
 * K9 编制/使用手册弹窗 — 对齐 E1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：K9-2 明细按费用性质登记发生额（损益类取发生额非余额）→ K9-4 分析 + K9-6/K9-7 截止 → K9-5/K9-8 检查 → 差异进 K9-3 → 确认回写 K9-1 → 勾稽 TB(6602) → 附注。本弹窗不改各表页内说明。"
    />
