...
const sheets = computed<SheetEntry[]>(() => {
  const defs: Omit<SheetEntry, 'completed'>[] = [
    ...
    { seq: 9, code: 'H3-8', name: '公允价值复核', purpose: '面积×参考单价复核+差异分析+收益法交叉验证', modeTag: '公允', sheetName: 'H3-8 公允价值复核' },
    { seq: 10, code: 'H3-9', name: '盘点检查', purpose: '双向抽盘+三数量+IR列+覆盖率', modeTag: '', sheetName: 'H3-9 盘点检查' },
    ...
    { seq: 13, code: 'H3-12', name: '产权核对', purpose: '三段式+H3-2/9/L1联动+附注受限+办证中+抽样', modeTag: '', sheetName: 'H3-12 产权核对' },
    { seq: 14, code: 'H3-13', name: '关联交易', purpose: '11列+定价公允性+差异率>10%红色+与H3-14勾稽', modeTag: '', sheetName: 'H3-13 关联交易' },
    { seq: 15, code: 'H3-14', name: '租金收入', purpose: '应计vs已计/H3-2带入/D4-3联动/日后收款', modeTag: '', sheetName: 'H3-14 租金收入' },
...
<style scoped>
.h3-tab-index { padding: 16px; font-size: var(--wp-font-size, 13px); }
.guide-area {
