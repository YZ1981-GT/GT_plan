...
// ─── 审计说明 / 审计结论 ───────────────────────────────────────────────────────
const NOTE_KEY = 'F2-disclosure-listed-audit-note'
const CONCLUSION_KEY = 'F2-disclosure-listed-audit-conclusion'
const auditNote = ref('')
  ...
  <div class="f2-disclosure-listed">
    ...
    <template v-else>
      ...
      <el-alert
        ...
        title="审计目标：核实上市公司存货附注披露的分类、账面价值与跌价准备的完整、准确，确保与 F2-1 审定表及财务报表列报一致。"
      />
      ...
      <el-card shadow="never" class="audit-note-card">
        ...
        <el-input
          ...
          :disabled="isReadonly"
          :autosize="{ minRows: 5 }"
          placeholder="填写审计说明：概述存货附注分类披露的取数来源、与审定表核对情况及重大披露事项。"
