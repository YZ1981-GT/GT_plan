...
/**
 * F2 编制/使用手册弹窗 — 对齐 D1/E1 PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  <el-dialog
    ...
    title="F2 存货及存货跌价准备 · 编制手册"
    width="860px"
    top="4vh"
    destroy-on-close
    append-to-body
    class="f2-handbook-dialog"
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：F2-2 明细汇总立清单 → 监盘/出入库/委托加工核数量 → F2-38/39/40 计价 + F2-41~44 成本归集 → F2-47 减值(NRV vs 成本) → 差异进 F2-14 → 回写 F2-1 → 勾稽 TB(1401/1471) → 附注。本弹窗不改各表页内说明。"
    />
