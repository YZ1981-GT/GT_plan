...
<style scoped>
.f2-related-purchase { padding: 12px; font-size: var(--wp-font-size, 13px); }
.f2-related-purchase :deep(.el-table) { --el-table-font-size: var(--wp-font-size, 13px); font-size: var(--wp-font-size, 13px); }
.f2-related-purchase :deep(.el-table .cell) { font-size: var(--wp-font-size, 13px) !important; }
/* 编制提示（蓝色） */
