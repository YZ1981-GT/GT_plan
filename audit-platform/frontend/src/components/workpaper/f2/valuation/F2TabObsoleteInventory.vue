...
<style scoped>
.f2-obsolete { padding: 12px; font-size: var(--wp-font-size, 13px); }
.f2-obsolete :deep(.el-table) { --el-table-font-size: var(--wp-font-size, 13px); font-size: var(--wp-font-size, 13px); }
.f2-obsolete :deep(.el-table .cell) { font-size: var(--wp-font-size, 13px) !important; }
