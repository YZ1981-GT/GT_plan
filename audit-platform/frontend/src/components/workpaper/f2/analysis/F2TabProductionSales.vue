...
// ─── 审计说明 / 审计结论 ───────────────────────────────────────────────────────
const NOTE_KEY = 'F2-production-sales-audit-note'
const CONCLUSION_KEY = 'F2-production-sales-audit-conclusion'
const auditNote = ref('')
  ...
  <div class="f2-production-sales">
    ...
    <el-card shadow="never" class="audit-note-card">
      ...
      <el-input
        ...
        :disabled="isReadonly"
        :autosize="{ minRows: 5 }"
        placeholder="填写审计说明：概述所执行的产销量与库存勾稽核查程序、测试情况与结果，以及滞销/积压风险的核查与拟调整/未调整事项及其影响。"
...
<style scoped>
.f2-production-sales { padding: 12px; font-size: var(--wp-font-size, 13px); }
.f2-production-sales :deep(.el-table) { --el-table-font-size: var(--wp-font-size, 13px); font-size: var(--wp-font-size, 13px); }
