...
/**
 * H1 编制/使用手册弹窗 — 镜像 D1/E1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：H1-2 明细立清单 → 监盘(H1-9~11)取实存 → 折旧(H1-12~13)/减值(H1-14~15)计价 → 权属/增减/关联检查 → 差异进 H1-3 → 回写 H1-1 → 勾稽 TB(1601/1602) → 附注。本弹窗不改各表页内说明。"
    />
