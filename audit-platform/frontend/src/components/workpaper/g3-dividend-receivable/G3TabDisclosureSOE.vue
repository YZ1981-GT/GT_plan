...
<template>
  <div class="g3-disclosure-soe">
    ...
    <el-alert
      ...
      title="审计目标：复核国企应收股利附注披露的完整性与准确性，确保与审定数勾稽一致，符合列报披露要求。"
    />
    ...
    <el-card class="audit-note-card" shadow="never">
      ...
      <el-input
        ...
        :autosize="{ minRows: 5 }"
        :disabled="isReadonly"
        placeholder="填写审计说明：概述国企应收股利披露的复核程序、与审定数勾稽核对结果、列报是否符合准则要求。"
        @change="persistNote"
      />
    </el-card>
    ...
    <details class="guidance-details">
      ...
      <div class="guidance-content">
        <p>1. 国企附注格式（29 行 ×5 列），简化列示期初/期末金额。</p>
        <p>2. 期末余额 = 期初余额 + 本期变动（灰色底纹为自动计算列）。</p>
...
const NOTE_KEY = 'G3-disclosure-soe-audit-note'
const CONCLUSION_KEY = 'G3-disclosure-soe-audit-conclusion'
