<template>
  <div class="g3-import-export-dropdown">
...
/**
 * G3 导入导出下拉 — 对齐 F2/G2（导出模板 / 导出数据 / 导入数据）
 */
import { ref, toRef } from 'vue'
import { ElMessage } from 'element-plus'
import { useG3ImportExport, type G3ImportableSheet } from '../composables/useG3ImportExport'

const props = defineProps<{
  wpId: string
  sheet: G3ImportableSheet
  disabled?: boolean
}>()
...
const ie = useG3ImportExport({ wpId: toRef(props, 'wpId') })
