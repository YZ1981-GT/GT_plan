...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：明细按成熟/未成熟分类 → 成本模式仅成熟直线法折旧+减值 或 公允价值模式变动计当期损益 → 消耗性与生产性互转核查 → 回写审定表勾稽TB 1621。CAS5生物资产,行业专属农林牧渔。"
    />
