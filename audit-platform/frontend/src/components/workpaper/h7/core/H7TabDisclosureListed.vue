      ...
      <template #header>
        <div class="section-title">
          ...
          <div class="title-actions">
            <el-button size="small" type="primary" link @click="handleAi('disc-listed')"><el-icon><MagicStick /></el-icon> AI生成</el-button>
...
<style scoped>
.h7-tab-disclosure-listed { padding: 16px; font-size: 13px; }
