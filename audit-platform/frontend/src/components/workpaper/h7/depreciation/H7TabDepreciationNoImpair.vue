      ...
      <template #header>
        <div class="section-title">
          ...
          <div class="title-actions">
            <el-button size="small" type="primary" link @click="handleAi('dep-noimp')"><el-icon><MagicStick /></el-icon> AI生成</el-button>
...
<style scoped>
.h7-tab-depreciation-no-impair { padding: 16px; font-size: 13px; }
