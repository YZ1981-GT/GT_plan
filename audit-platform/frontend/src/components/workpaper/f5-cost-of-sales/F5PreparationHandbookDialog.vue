...
/**
 * F5 编制/使用手册弹窗 — 对齐 D1/E1 PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：F5-2 月度明细立清单 → F5-6 数量核对 + F5-7 成本倒轧(与 F2 存货勾稽) → F5-5 毛利分析(与 D4 收入配比) → F5-8 重大调整核查 → 差异进 F5-4 → 回写 F5-1 → 勾稽 TB(6401 发生额)。本弹窗不改各表页内说明。"
    />
