...
/**
 * N1 编制/使用手册弹窗 — 对齐 E1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  <el-dialog
    ...
    title="N1 递延所得税资产 · 编制手册"
    width="860px"
    top="4vh"
    destroy-on-close
    append-to-body
    class="n1-handbook-dialog"
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：N1-4 测算(暂时性差异×税率) + N1-5 亏损充足性 → N1-2 明细 → 差异进 N1-3 → 确认回写 N1-1 → 勾稽 TB(1811) + 核对 N3/N5 → 附注。资产类借方取期末余额。本弹窗不改各表页内说明。"
    />
