...
.g2-voucher-check :deep(.el-table) { --el-table-font-size: var(--wp-font-size, 13px); font-size: var(--wp-font-size, 13px); }
.g2-voucher-check :deep(.el-table .cell) { font-size: var(--wp-font-size, 13px) !important; }
