<template>
  <div class="g2-import-export-dropdown">
...
/**
 * G2 导入导出下拉 — 对齐 F2/G1（导出模板 / 导出数据 / 导入数据）
 */
import { ref, toRef } from 'vue'
import { ElMessage } from 'element-plus'
import { useG2ImportExport, type G2ImportableSheet } from '../composables/useG2ImportExport'

const props = defineProps<{
  wpId: string
  sheet: G2ImportableSheet
  disabled?: boolean
}>()
...
const ie = useG2ImportExport({ wpId: toRef(props, 'wpId') })
