...
// 章节 ID → 显示名称映射（与实物 A17-1 16 章目录一致）
const chapterLabels: Record<string, string> = {
  'A17-1-ch01': '第1章 审计业务约定范围及执行情况',
  'A17-1-ch02': '第2章 独立性',
  'A17-1-ch03': '第3章 对审计计划的更新和修改',
  'A17-1-ch04': '第4章 需合伙人关注事项',
  'A17-1-ch05': '第5章 业务咨询及专业意见分歧',
  'A17-1-ch06': '第6章 重大错报风险应对',
  'A17-1-ch07': '第7章 利用专家的工作',
  'A17-1-ch08': '第8章 已审财务报表分析',
  'A17-1-ch09': '第9章 关联方及关联方交易',
  'A17-1-ch10': '第10章 持续经营',
  'A17-1-ch11': '第11章 期后事项',
  'A17-1-ch12': '第12章 关键审计事项（KAM）',
  'A17-1-ch13': '第13章 其他信息',
  'A17-1-ch14': '第14章 财务报表审计结论',
  'A17-1-ch15': '第15章 其他特殊考虑事项',
  'A17-1-ch16': '第16章 提请下年度关注',
  'A17-3': 'A17-3 业务咨询记录',
  'A17-3-1': 'A17-3-1 咨询结果执行',
  'A17-7': 'A17-7 独立性声明',
}
