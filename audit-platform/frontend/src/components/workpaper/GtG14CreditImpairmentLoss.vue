<template>
  <div class="g14-credit-impairment-loss">
    ...
    <template v-else>
      <div class="g14-credit-impairment-loss-toolbar">
        <el-button size="small" @click="versionToolbar.openVersionHistory()">版本历史</el-button>
      </div>

      <GtOnlyOfficeSheet
        v-if="currentSheet === 'G14A'"
        :wp-id="props.wpId"
...
import { useG14CreImpFormData } from './composables/useG14CreImpFormData'
...
const formData = useG14CreImpFormData({ wpId: wpIdRef, projectId: computed(() => props.projectId) })
...
const useGridFallback = computed(() => {
  ...
  return !!code && code !== 'G14A' && !adjudicationConfig.value && !code.startsWith('附注')
})
...
.g14-credit-impairment-loss-toolbar { margin-bottom: 8px; }
</style>
