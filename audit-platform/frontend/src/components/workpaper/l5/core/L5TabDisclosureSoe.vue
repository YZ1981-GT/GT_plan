...
function handleAI(section: string) {
  import('@/utils/http').then(({ default: h }) => {
    h.post(`/api/workpapers/${props.wpId}/ai/generate-text`, {
      section: `l5-disclosure-soe-${section}`,
...
function saveConclusion() { formData.debouncedSave('L5-disc-soe-conclusion', { remark: conclusion.value || null }) }
...
<style scoped>
.l5-tab-disclosure-soe { padding: 12px; font-size: var(--wp-font-size, 13px); }
