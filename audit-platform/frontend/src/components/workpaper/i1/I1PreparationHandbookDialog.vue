...
/**
 * I1 编制/使用手册弹窗 — 对齐 L1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：I1-2 明细(原值/摊销/减值分列) + I1-9~11 摊销测算 + I1-12~13 减值测试 → I1-1 审定(三科目三角勾稽：原值−累计摊销−减值=净值) → 回写 TB(1701/1702/1703)+附注。1701 资产借方(期末=期初+借−贷)，1702/1703 备抵贷方(期末=期初+贷−借)。I1-5 增加可带入 I2 资本化转入。本弹窗不改各表页内说明。"
    />
