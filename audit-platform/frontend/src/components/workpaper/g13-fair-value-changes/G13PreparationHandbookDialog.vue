...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="公允价值变动损益(6101损益类) —— 来源:交易性金融资产/负债(G1/G10)、其他非流动金融资产(G9)、投资性房地产(公允模式)本期公允价值变动，按来源分项勾稽 → 处置时不结转 → 审定回写 → 附注。本弹窗不改各表页内说明。"
    />
