...
.d3-long-term :deep(.el-table) { --el-table-font-size: var(--wp-font-size, 13px); font-size: var(--wp-font-size, 13px); }
.d3-long-term :deep(.el-table .cell) { font-size: var(--wp-font-size, 13px) !important; }
