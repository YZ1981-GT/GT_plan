...
/**
 * F1 编制/使用手册弹窗 — 对齐 D1/E1 PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：F1-2 明细立清单 → 函证/关联方/综合检查取证 → F1-4 分析与 F1-5 长期挂账判断重分类 → 差异进 F1-3 → 确认回写 F1-1 → 勾稽 TB(1123) → 附注。本弹窗不改各表页内说明。"
    />
