...
/**
 * M4 编制/使用手册弹窗 — 对齐 N5PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：M4-2 明细(资本溢价 + 其他资本公积) + M4-4 形成依据核对 → M4-1 审定(未审+AJE+RJE) → 回写 TB(4002)+附注。资本公积是权益类贷方：期末=期初+贷方−借方；J3 股份支付权益结算、M2 外币折算差异计入其他资本公积/资本溢价。本弹窗不改各表页内说明。"
    />
