...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="信用减值损失(6702损益类) —— 来源:应收款项/债权投资/其他债权投资(G6)的 ECL 计提，三阶段模型 → 与各金融资产减值准备本期变动勾稽 → 审定回写 → 附注。区别资产减值损失(6701/K11)。本弹窗不改各表页内说明。"
    />
