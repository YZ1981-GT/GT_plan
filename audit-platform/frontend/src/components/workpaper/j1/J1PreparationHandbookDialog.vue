...
/**
 * J1 编制/使用手册弹窗 — 对齐 N1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  <el-dialog
    ...
    title="J1 应付职工薪酬 · 编制手册"
    width="860px"
    top="4vh"
    destroy-on-close
    append-to-body
    class="j1-handbook-dialog"
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：J1-2 明细按项目 → J1-6/7 计提分配检查 → J1-8/9/10 凭证与特殊福利 → 差异进 J1-3 → 回写 J1-1 → 勾稽 TB(2211) → 附注。负债类贷方：期末=期初+计提−支付。本弹窗不改各表页内说明。"
    />
