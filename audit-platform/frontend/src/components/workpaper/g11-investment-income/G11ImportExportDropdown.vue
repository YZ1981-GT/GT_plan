...
import { useG11ImportExport, type G11ImportableSheet } from '../composables/useG11ImportExport'

const props = defineProps<{ wpId: string; sheet: G11ImportableSheet }>()
const emit = defineEmits<{ imported: [] }>()

const fileRef = ref<HTMLInputElement | null>(null)
const ie = useG11ImportExport({ wpId: toRef(props, 'wpId') })
