...
/**
 * K13 编制/使用手册弹窗 — 对齐 E1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  <el-dialog
    ...
    title="K13 营业外支出 · 编制手册"
    width="860px"
    top="4vh"
    destroy-on-close
    append-to-body
    class="k13-handbook-dialog"
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：K13-2 明细按性质登记借方发生额（损益类取发生额非余额）→ K13-4 凭证级检查（税前扣除性）→ 差异进 K13-3 → 确认回写 K13-1 → 勾稽 TB(6711) → 附注。关注罚款/滞纳金等不得税前扣除的纳税调整。本弹窗不改各表页内说明。"
    />
