<template>
  <div class="g10-import-export-dropdown">
...
import { useG10ImportExport, type G10ImportableSheet } from '../composables/useG10ImportExport'

const props = defineProps<{ wpId: string; sheet: G10ImportableSheet }>()
const emit = defineEmits<{ imported: [] }>()

const fileRef = ref<HTMLInputElement | null>(null)
const ie = useG10ImportExport({ wpId: toRef(props, 'wpId') })
