...
<style scoped>
.f2-undisclosed { padding: 12px 16px; font-size: 13px; }
.f2-undisclosed :deep(.el-table) { --el-table-font-size: 13px; font-size: 13px; }
.f2-undisclosed :deep(.el-table .cell) { font-size: 13px !important; }
