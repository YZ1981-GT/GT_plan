...
<div class="d3-related-party">
  ...
  <div class="rp-toolbar">
    ...
    <el-button-group size="small" style="margin-left: auto">
      <el-button @click="exportTemplate('D3-6')">导出模板</el-button>
      <el-button @click="exportData('D3-6')">导出数据</el-button>
      <el-upload :show-file-list="false" accept=".xlsx" :before-upload="(file: any) => handleImport(file, 'D3-6')">
...
function openReview() {
  openReviewDialog('D3-rp-conclusion')
}
