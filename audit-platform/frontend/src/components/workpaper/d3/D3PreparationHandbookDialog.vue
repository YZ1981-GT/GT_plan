...
/**
 * D3 编制/使用手册弹窗 — 对齐 E1/K2PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：D3-2 明细立清单(标注账龄) → 分析/凭证检查取证 → 长期挂账(D3-5)判处理 → 差异进 D3-3 → 确认回写 D3-1 → 勾稽 TB(2203) → 附注。本弹窗不改各表页内说明。"
    />
