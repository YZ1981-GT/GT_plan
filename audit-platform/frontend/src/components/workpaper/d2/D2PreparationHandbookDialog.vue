...
/**
 * D2 编制/使用手册弹窗 — 对齐 E1/K2PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：D2-2 明细立清单(标注信用风险组合方式) → 政策/坏账测算/ECL 取证 → 差异进 D2-4 → 确认回写 D2-1 → 勾稽 TB(1122) → 附注。本弹窗不改各表页内说明。"
    />
