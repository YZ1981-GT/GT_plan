...
/**
 * K3 编制/使用手册弹窗 — 对齐 E1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：K3-2 明细按对象+账龄立清单 → 大额(K3-4)/长挂(K3-5)/关联方(K3-6)专项检查 → K3-7 综合检查含反向截止(完整性) → 差异进 K3-3 → 确认回写 K3-1 → 勾稽 TB(2241) → 附注。本弹窗不改各表页内说明。"
    />
