...
<template>
  <div class="d7-tab-index">
    ...
    <D7PreparationHandbookDialog v-model="handbookVisible" :initial-tab="handbookTab" />
    ...
    <details class="methodology-hint">
      ...
      <p>推荐工作流：D7A 程序表 → D7-2 明细（标注账龄）→ D7-4 分析 → D7-7 凭证检查 → D7-5 账龄1年以上检查（判处理）→ D7-3 调整分录 → 确认回写 D7-1。长期挂账应确认收入的与 D4 勾稽。</p>
    </details>
