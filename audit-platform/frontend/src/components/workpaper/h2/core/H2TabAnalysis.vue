  ...
  <div class="h2-tab-analysis">
      ...
      <template #header>
        <div class="section-header">
          ...
          <div class="section-header-actions">
            <el-button size="small" type="primary" link @click="handleAiGenerate('analysis-progress')">
    ...
    <el-card shadow="never" class="audit-note-card">
      <template #header>
        <div class="section-header">
          <span>分析结论</span>
          <el-button size="small" type="primary" link @click="handleAiGenerate('analysis-conclusion')">
...
<style scoped>
.h2-tab-analysis { padding: 16px; font-size: 13px; }
.methodology-context {
