...
import { useG4BonEclFormData } from './composables/useG4BonEclFormData'
...
const formData = useG4BonEclFormData({ wpId: wpIdRef, projectId: computed(() => props.projectId) })
...
<style scoped>.g4-bond-investment-ecl { padding: 12px; } .loading-container { padding: 24px; } .g4-bond-investment-ecl-toolbar { margin-bottom: 8px; }</style>
