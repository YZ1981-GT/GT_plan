...
function saveNoteText() {
  props.allResponses.set('H6-disclosure-listed-text', {
    item_id: 'H6-disclosure-listed-text', remark: noteText.value, conclusion: null,
  })
}
...
<style scoped>
.h6-tab-disclosure-listed { padding: 16px; font-size: 13px; }
