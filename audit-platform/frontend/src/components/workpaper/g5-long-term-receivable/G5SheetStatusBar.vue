<template>
  <section class="g5-status-panel" data-testid="g5-sheet-status">
...
import { evaluateG5SuiteStatus } from '../composables/g5SuiteStatus'

const props = defineProps<{
  allResponses: Map<string, ChecklistResponse>
}>()

const items = computed(() => evaluateG5SuiteStatus(props.allResponses))
</script>
