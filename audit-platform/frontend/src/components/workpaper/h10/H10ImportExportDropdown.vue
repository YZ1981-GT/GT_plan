...
import { useH10ImportExport, type H10ImportableSheet } from '../composables/useH10ImportExport'

const props = defineProps<{ wpId: string; sheet: H10ImportableSheet }>()
const emit = defineEmits<{ imported: [] }>()

const fileRef = ref<HTMLInputElement | null>(null)
const ie = useH10ImportExport({ wpId: toRef(props, 'wpId') })
