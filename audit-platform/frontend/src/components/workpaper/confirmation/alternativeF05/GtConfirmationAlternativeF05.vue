<template>
  <div class="gt-confirmation-alternative-f05">
    ...
    <template v-else>
      <!-- 顶部说明 -->
      <div class="gt-confirmation-alternative-f05__header-tip">
                ...
                <el-col :span="12">
                  <el-form-item label="测试范围">
                    <el-input
                      ...
                      type="textarea"
                      :rows="2"
                      placeholder="如预付账款借方发生额所有凭证共XX笔金额XX、贷方发生额所有凭证共XX笔金额XX"
                      @change="markDirty"
                    />
                  </el-form-item>
                </el-col>
...
function handleImportF01() {
  // TODO: 跨底稿引用获取 F0-1 未回函预付账款公司（待 dispatch persistence 接入）
