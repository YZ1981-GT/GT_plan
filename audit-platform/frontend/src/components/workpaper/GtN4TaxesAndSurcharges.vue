<template>
  <div class="n4-taxes-and-surcharges">
    ...
    <template v-else>
      <div class="n4-taxes-and-surcharges-toolbar">
        <el-segmented
          v-if="isHtmlSheet"
...
provide('n4VersionTrailRef', versionTrailRef)
provide('n4OpenVersionHistory', () => versionToolbar.openVersionHistory())
...
function openReviewDialog(sectionId: string): void {
  console.log('[N4] openReviewDialog:', sectionId)
}
