...
/**
 * I6 编制/使用手册弹窗 — 对齐 I1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：6602 研发费用是损益类，取本期发生额（非余额）。I6-2 月度明细 → I6-1 审定（本期发生额）→ 回写 TB(6602)+附注。费用化(I6)+资本化(I2)=研发总额（VR-I6-01）。本弹窗不改各表页内说明。"
    />
