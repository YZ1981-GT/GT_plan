...
/**
 * E1 编制/使用手册弹窗 — 对齐 G1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：明细(E1-2/3/4)立清单 → 存在/完整/计价分表取证 → 差异进 E1-5 → 确认回写 E1-1 → 勾稽 TB/现金流量表 → 附注。本弹窗不改各表页内说明。"
    />
