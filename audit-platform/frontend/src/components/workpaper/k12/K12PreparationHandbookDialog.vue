...
/**
 * K12 编制/使用手册弹窗 — 对齐 E1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  <el-dialog
    ...
    title="K12 营业外收入 · 编制手册"
    width="860px"
    top="4vh"
    destroy-on-close
    append-to-body
    class="k12-handbook-dialog"
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：K12-2 明细逐笔立清单 → K12-4 凭证级核实分类(6301 vs 6117) → 差异进 K12-3 → 确认回写 K12-1 → 勾稽 TB(6301) → 附注。损益类取发生额非余额。本弹窗不改各表页内说明。"
    />
