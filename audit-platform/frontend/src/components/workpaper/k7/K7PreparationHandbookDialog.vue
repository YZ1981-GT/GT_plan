...
/**
 * K7 编制/使用手册弹窗 — 对齐 E1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：K7-2 明细登记政府补助收到/分摊 → K7-4 分摊测算(CAS16直线分摊)+差异标记 → K7-5 检查 → 差异进 K7-3 → 确认回写 K7-1 → 勾稽 TB(2401) → 附注(按相关类型)。分摊去向：其他收益(K10)/营业外收入(K12)。本弹窗不改各表页内说明。"
    />
