...
/**
 * K8 编制/使用手册弹窗 — 对齐 E1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：销售费用(6601)取发生额非余额。K8-2 明细按科目登记发生额 → K8-4 实质性分析 → K8-6/K8-7 双向截止 → K8-5 合同/K8-8 综合检查 → 差异进 K8-3 → 确认回写 K8-1 → 勾稽 TB(6601 发生额) → 附注。本弹窗不改各表页内说明。"
    />
