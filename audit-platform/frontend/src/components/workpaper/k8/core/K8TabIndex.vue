...
<style scoped>
.k8-tab-index { padding: 12px; font-size: var(--wp-font-size, 13px); }
...
.k8-guide-header { display: flex; align-items: center; gap: 6px; font-weight: 500; color: #1a73e8; margin-bottom: 10px; font-size: var(--wp-font-size, 13px); }
