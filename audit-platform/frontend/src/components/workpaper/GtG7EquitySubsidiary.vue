<template>
  <div class="g7-long-term-equity-subsidiary">
    ...
    <template v-else>
      <div class="g7-long-term-equity-subsidiary-toolbar">
...
import { useG7EquSubFormData } from './composables/useG7EquSubFormData'
...
const formData = useG7EquSubFormData({ wpId: wpIdRef, projectId: computed(() => props.projectId) })
...
<style scoped>.g7-long-term-equity-subsidiary { padding: 12px; } .loading-container { padding: 24px; } .g7-long-term-equity-subsidiary-toolbar { margin-bottom: 8px; }</style>
