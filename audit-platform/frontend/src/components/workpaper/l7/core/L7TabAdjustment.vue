...
const {
  ...
  wpCode: 'L7',
  itemId: () => `L7-adj-${activeType.value}`,
  buildLineItems: () =>
...
<style scoped>
.l7-tab-adjustment { padding: 12px; font-size: var(--wp-font-size, 13px); }
