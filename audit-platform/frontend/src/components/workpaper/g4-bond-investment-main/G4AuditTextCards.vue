...
import { useG4MainAiGenerate, type G4MainAiSection } from '../composables/useG4MainAiGenerate'
...
const props = withDefaults(defineProps<{
  ...
  noteAiSection?: G4MainAiSection | ''
  conclusionAiSection?: G4MainAiSection | ''
...
const { aiAvailable, loading: aiLoading, generateAndConfirm } = useG4MainAiGenerate(wpIdRef)
...
<style scoped>
.g4-audit-text-cards { display: flex; flex-direction: column; gap: 0; }
.audit-text-card {
  margin-top: 14px;
