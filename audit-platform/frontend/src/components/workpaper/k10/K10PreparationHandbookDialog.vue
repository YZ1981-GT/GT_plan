...
/**
 * K10 编制/使用手册弹窗 — 对齐 E1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：K10-2 明细按补助项目登记贷方发生额（损益类取发生额非余额）→ K10-4 政府补助核对（与 K7 递延分摊一致）→ K10-5/K10-6 检查 → 差异进 K10-3 → 确认回写 K10-1 → 勾稽 TB(6117) → 附注。本弹窗不改各表页内说明。"
    />
