...
/**
 * D1 编制/使用手册弹窗 — 对齐 E1/K2PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：D1-2/D1-3 明细立清单 → 监盘/核对/贴现背书取证 → 坏账(D1-4)与 ECL(D1-15)勾稽 → 差异进 D1-5 → 确认回写 D1-1 → 勾稽 TB(1121) → 附注。本弹窗不改各表页内说明。"
    />
