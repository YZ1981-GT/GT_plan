...
/**
 * I2 编制/使用手册弹窗 — 对齐 I1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：1717 开发支出资产借方(期末=期初+借−贷)。资本化归集研发支出，达 CAS6 五条件(技术可行/意图/经济利益/资源支持/可靠计量同时满足)即计入 → I2-6 逐项目资本化时点判断。费用化(I6)+资本化(I2)=研发总额双向校验。项目完成转入 I1 无形资产(I1-5 带入)。I2-1 审定回写 TB(1717)+附注。本弹窗不改各表页内说明。"
    />
