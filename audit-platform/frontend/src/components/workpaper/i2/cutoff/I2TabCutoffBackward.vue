  ...
  <div class="i2-cutoff-backward">
    ...
    <div class="tab-toolbar">
      ...
      <div class="toolbar-right">
        <GtIndexChip value="wp:I2-14" :context-project-id="props.projectId" />
    ...
    <details class="guidance-details">
      ...
      <div class="guidance-content">
        <p>1. 本表为「单据→账簿」方向：从期末前后支出凭单（领料单、工时单、委外结算单等）出发，追查是否已入账。</p>
        <p>2. 跨期判定：支出凭单日期与记账日期分处截止日两侧即为跨期；跨期金额自动取支出凭单金额。</p>
        <p>3. 截止日前单据记入下期 → 跨期漏记；截止日后单据提前记入本期 → 本期多计。</p>
        <p>4. 发现跨期或存在舞弊风险时，应扩大窗口至报告日，并与 I2-13（账→单据）综合评价；依据 CAS6《无形资产》。</p>
      </div>
    </details>
  </div>
</template>
