...
/**
 * N2 编制/使用手册弹窗 — 对齐 N1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：N2-6/N2-8/N2-9/N2-10 各税种测算 → N2-2 明细 → 差异进 N2-3 → 确认回写 N2-1 → 勾稽 TB(2221) + 各税种计提额核对 N4 → 附注。负债类贷方取期末余额。本弹窗不改各表页内说明。"
    />
