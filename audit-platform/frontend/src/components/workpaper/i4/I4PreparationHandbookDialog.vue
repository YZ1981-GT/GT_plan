...
/**
 * I4 编制/使用手册弹窗 — 对齐 I1/N1PreparationHandbookDialog，渲染 handbooks/*.md
 */
...
<template>
  <el-dialog
    ...
    title="I4 长期待摊费用 · 编制手册"
    width="860px"
    top="4vh"
    destroy-on-close
    append-to-body
    class="i4-handbook-dialog"
  ...
  >
    <el-alert
      ...
      show-icon
      class="mb12"
      title="一句话：长期待摊费用（1801 资产借方，期末=期初+增−摊−减）—— I4-2 明细 → I4-1 审定带入 → I4-4 政策 → I4-5 抽凭 → I4-6/7 摊销测算（二选一）→ 回写 TB → 附注。本弹窗不改各表页内说明。"
    />
