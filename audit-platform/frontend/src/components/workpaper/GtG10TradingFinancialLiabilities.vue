<template>
  <div class="g10-trading-financial-liabilities">
    ...
    <template v-else>
      <div class="g10-trading-financial-liabilities-toolbar">
        <el-button size="small" @click="versionToolbar.openVersionHistory()">版本历史</el-button>
      </div>

      <GtOnlyOfficeSheet
        v-if="currentSheet === 'G10A'"
        :wp-id="props.wpId"
...
import { useG10TraFinFormData } from './composables/useG10TraFinFormData'
...
const formData = useG10TraFinFormData({ wpId: wpIdRef, projectId: computed(() => props.projectId) })
...
const useGridFallback = computed(() => {
  ...
  return !!code && code !== 'G10A' && !adjudicationConfig.value && !code.startsWith('附注')
})
...
.g10-trading-financial-liabilities-toolbar { margin-bottom: 8px; }
</style>
