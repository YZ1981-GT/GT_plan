  ...
  <div class="l1-tab-adjustment">
    ...
    <div class="adj-header">
      <div class="adj-header-left">
        ...
        <h3 class="adj-title">L1-3 调整分录汇总</h3>
      </div>
    ...
    <div class="methodology-context">
      <div class="methodology-text">
        ...
        不平衡时无法保存。保存后自动同步至 L1-1 审定表的 AJE/RJE 列，并通知 A13 审计调整汇总。
      </div>
    </div>
    ...
    <details class="l1-details-tip">
      ...
      <ul>
        ...
        <li><strong>净影响</strong>：仅统计科目编码为"2001"的分录行的净增减</li>
...
function handleTypeSwitch(val: string | number) {
  switchType(val as AdjustmentType)
}
